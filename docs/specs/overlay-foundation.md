...
| **Status** | `done` — 2026-09-26, through 4.2's baseline, CI-authored and compared green (D-013). Gate C passed 2026-09-26 **by delegation** (D-061), every recommendation adopted as written. Built with 4.2 `Popover` the same day (§9); findings in D-062 |
